...
const CANS = [
    ...
    "Share safe updates with the coordinator",
    "Stay nearby if it is safe to do so",
    "Coordinate with trained professionals",
];
...
const CANNOTS = [
    ...
    "Perform any legal intervention",
    "Make accusations",
];

export default function L1Safety() {
    return (
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-10 py-4 sm:py-6 lg:py-10 space-y-6 sm:space-y-8">
            <PageHeader
                eyebrow="Level 1 · Safety"
                title="Know your role"
                description="Level 1 helps until professionals arrive. Nirikshan protects both the child and you."
            />
            ...
            <PrivacyNote>
                <div className="text-foreground font-medium flex items-center gap-1.5 mb-1">
                    <ShieldCheck className="h-4 w-4 text-primary" /> Your identity
                    is protected
                </div>
                Reporters and other responders never see your personal contact
                details. Coordination happens through Nirikshan.
            </PrivacyNote>
        </div>
    );
}
